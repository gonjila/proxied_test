...
export type AddItemMutation = { __typename?: 'Mutation', addItem: { __typename?: 'Cart', _id: string, hash: string, items: Array<{ __typename?: 'CartItem', _id: string, cartId: string, quantity: number, product: { __typename?: 'Product', _id: string, title: string, cost: number, availableQuantity: number, isArchived: boolean } }> } };
...
export type GetCartQuery = { __typename?: 'Query', getCart: { __typename?: 'Cart', _id: string, hash: string, items: Array<{ __typename?: 'CartItem', _id: string, cartId: string, quantity: number, product: { __typename?: 'Product', _id: string, title: string, cost: number, availableQuantity: number, isArchived: boolean } }> } };
